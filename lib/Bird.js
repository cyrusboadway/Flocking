define(['./Vector', './FuzzyLogicEngine'], function (Vector, FuzzyLogicEngine) {
	...
	Bird.intraBirdConditionPreprocessor = function (conditions) {
		var nearestLattice = conditions.bird.env.findClosestLatticeLocation(conditions.bird.position, conditions.destinationBird.position);
		var difference = conditions.bird.position.subtract(nearestLattice);
		return {
	...
	Bird.predatorConditionPreprocessor = function (conditions) {
		var nearestLattice = conditions.bird.env.findClosestLatticeLocation(conditions.bird.position, conditions.predator.position);
		var difference = conditions.bird.position.subtract(nearestLattice);
		return {
			difference: difference,
			distance: difference.getMagnitude(),
