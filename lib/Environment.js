define(['./Vector', './Bird', './Predator'], function(Vector, Bird, Predator){
	...
	/**
	 * Find the shortest vector between two points, including wrapping around the screen
	 *
	 * @param {Vector} origin
	 * @param {Vector} destination
	 * @returns {Vector}
	 */
	Environment.prototype.shortestPathBetweenPoints = function(origin, destination) {
		return this.findClosestLatticeLocation(origin, destination).subtract(origin);
	};
